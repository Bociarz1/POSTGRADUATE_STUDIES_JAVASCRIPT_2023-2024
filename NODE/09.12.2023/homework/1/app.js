...
// 1. Stworzenie aplikacji która pozwoli na zapisanie całego obiektu do pliku. Z wykorzystaniem funkcji pozwalającej na przekonwertowanie obiektu na postać tekstową(JSON.stringify). Zapisywane dane powinny być przekazywane do programu w parametrach uruchamiania. Do wykorzystania zewnętrzny moduł yargs. Wynik zapisać do pliku user.json za pomocą funkcji asynchronicznej fs.writeFile oraz callbacków.
// Obiekt do zapisu:
...
// Dodanie do naszej aplikacji z zadania 1 wczytanie już wcześniej zapisanego obiektu, przed nadpisaniem nowymi wartościami. W konsoli wypiszmy jedynie imię wczytanego użytkownika. Wszystkie operacja na plikach wykonujemy za pomocą modułu fs i funkcji asynchronicznych.

// Aplikacja która pobierze z zewnętrznego API informację o użytkowniku i wyświetli w konsoli współrzędne geograficzne skąd dany użytkownik pochodzi oraz jego imię.
...
// Rozszerzenie zadania 3 tak aby aplikacja poinformowała użytkownika o błędzie pobierania danych lub braku szukanego użytkownika w bazie.

// Dodajmy do zadania 4 dynamiczne wprowadzanie ID poprzez użycie zewnętrznej biblioteki yargs.
...
// User not found.
// Dodanie do zadanie 5 opcji pobrania pogody dla wczytanego użytkownika. Odpowiednie zabezpieczenie naszej aplikacji w przypadku błędu API (podobnie jak w zadaniu 5).
...
// Podziel aplikację z zadania 6 na funkcje:
...
// Napisz program, który po 4 sekundach wypisze komunikat Hello after 4 seconds, a po 8 sekundach Hello after 8 seconds. Możesz zdefiniować tylko jedną własną funkcję!
